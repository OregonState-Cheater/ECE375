;***********************************************************
;*
;*	Aaron_Vaughan_and_Bradley_Heenk_Lab1_challengecode.asm	-	V2.0
;*
...
;*	-	10/04/19 Heenk/Vaughan	Add challenge code
;*
;***********************************************************
...
.equ	WTimeBack = 200				; Time to wait in backup loop
...
HitRight:
		...
		ldi		waitcnt, WTimeBack	; Wait for 2 second
